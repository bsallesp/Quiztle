namespace Quiztle.API.Prompts
{
    public static class QuestionTypeGenerator
    {
        private static readonly string[] QuestionTypes = {
            ...
            "Characteristic Comparison: A question comparing characteristics between two ou mais itens.",
        ...
        public static List<string> GetRandomQuestionTypes(int count)
        {
            ...
            while (selectedTypes.Count < count)
            {
                ...
                selectedTypes.Add(QuestionTypes[index]);
            }
